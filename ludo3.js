...
for (let i = 0; i < parseInt(playerNum) && i < 4; i++) {
  const coins = [];
  coins.push(new Coin(`b0`, "blue", 11, 2, "../media/bluepng.png"));
  coins.push(new Coin(`b1`, "blue", 11, 3, "../media/bluepng.png"));
  coins.push(new Coin(`b2`, "blue", 12, 2, "../media/bluepng.png"));
  coins.push(new Coin(`b3`, "blue", 12, 3, "../media/bluepng.png"));
  ...
  coins.length = 0;
  // for (let j = 0; j < 4; j++) {
  coins.push(new Coin(`g0`, "green", 2, 11, "../media/greenpng.png"));
  coins.push(new Coin(`g1`, "green", 2, 12, "../media/greenpng.png"));
  coins.push(new Coin(`g2`, "green", 3, 11, "../media/greenpng.png"));
  coins.push(new Coin(`g3`, "green", 3, 12, "../media/greenpng.png"));
  // }
  ...
  coins.length = 0;
  coins.push(new Coin(`r0`, "red", 2, 2, "../media/redpng.png"));
  coins.push(new Coin(`r1`, "red", 2, 3, "../media/redpng.png"));
  coins.push(new Coin(`r2`, "red", 3, 2, "../media/redpng.png"));
  coins.push(new Coin(`r3`, "red", 3, 3, "../media/redpng.png"));
  ...
  coins.length = 0;
  coins.push(new Coin(`y0`, "yellow", 11, 11, "../media/yellowpng.png"));
  coins.push(new Coin(`y1`, "yellow", 11, 12, "../media/yellowpng.png"));
  coins.push(new Coin(`y2`, "yellow", 12, 11, "../media/yellowpng.png"));
  coins.push(new Coin(`y3`, "yellow", 12, 12, "../media/yellowpng.png"));
